...
public class CorporateCarRentalBdd extends CorporateCarRentalUI {

	WebDriver driver;
	Logger log;
	ExtentTest test;

	public CorporateCarRentalBdd(WebDriver driver, Logger log, ExtentTest test) throws Exception {
		this.driver = driver;
		this.test = test;
		this.log = log;
	}
	...
	public void details(String nm,String cnm,String em,String ph)throws ReusableComponentException, Exception{
		...
		WebDriverSupport.sendKeys(driver, Name, "name", "entered name", log, test,nm);
		WebDriverSupport.click(driver, companyName, "compname", "clicked company name", log, test);
		WebDriverSupport.sendKeys(driver, companyName, "compname", "entered company name", log, test,cnm);
		WebDriverSupport.click(driver, Email, "email", "clicked email", log, test);
		WebDriverSupport.sendKeys(driver, Email, "email", "entered email", log, test,em);
		WebDriverSupport.click(driver, phoneno, "phoneno", "clicked phone no", log, test);
		WebDriverSupport.sendKeys(driver, phoneno, "phoneno", "entered phone no", log, test,ph);
